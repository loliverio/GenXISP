...
# Phase 1
results_p2 = joinpath("results", "results_p2","power.csv")
power = CSV.read(results_p2, DataFrame, missingstring="NA")
tstart = 3
tend = 400
...
results_b = joinpath("results", "results_p2", "charge.csv")
...
case = joinpath("inputs","inputs_p2","TDR_results","Demand_data.csv")
